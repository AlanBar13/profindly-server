...
export const getSpecialist = asyncHandler(async (req: Request, res: Response) => {
...
export const updateSpecialist = asyncHandler(async (req: Request, res: Response) => {
    ...
    if (specialist) {
        ...
        specialist.budget_range = req.body.budget_range || specialist.budget_range;
        ...
        specialist.subspecialities = req.body.subspecialities || specialist.subspecialities;
        specialist.specialist_id = req.body.specialist_id || specialist.specialist_id;
